...
def main():
    ...
    if coordinator.is_master():
        ...
        if cfg.get("wandb", False):
            wandb.init(project="Open-Sora", name=exp_name, entity="rleai", config=cfg.to_dict(), dir="./outputs/wandb", mode="offline")
    ...
    try:
        ...
        logger.info("Dataset contains unknown number of samples.")
    ...
    if vae is not None:
        input_size = (dataset.context_length, *dataset.image_size)
    ...
    for epoch in range(start_epoch, cfg_epochs):
        ...
        with tqdm(
            ...
            for step, batch in pbar:
                ...
                # os.makedirs(f"./debug/1/", exist_ok=True)
                # log_file = open(f"./debug/1/debug_rank_{rank}.log", "a")
